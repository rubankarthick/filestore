...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5777838885:AAHl-iGzTPuvWOnEKFDdai0kT8J1kmWS9OI")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001959857772"))
